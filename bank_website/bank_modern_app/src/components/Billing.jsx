...
const Billing = () => (
  <section id="product" className={`${layout.sectionReverse}`}>
    <div className={`${layout.sectionImgReverse}`}>
      ...
      <div className="absolute z-[3] top-0 -left-1 w-[50%] h-[50%] rounded-full white__gradient" />
      <div className="absolute z-[0] bottom-0 -left-1 w-[50%] h-[50%] rounded-full pink__gradient" />
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
        ...
        <img src={google} alt="goople_play" className="w-[128px] h-[42px] object-contain cursor-pointer" />
      </div>
    </div>
  </section>
)
